---
title: "Data Visulatization Approaches in Scientific & Clinical Research"
...
- Discuss select plot examples from a research article
...
::: columns
::: {.column width="50%"}
**Survey of clinical literature: 175 figures across 77 papers in the following medical journals**:
...
::: columns
::: {.column width="50%"}
**Survey of biomedical literature: 227,998 PubMed Central articles across 23 fields**:
...
:::
<span style="font-size:60%">Riedel, N. Clinical Scienence (Lond). 2022.</span>
:::
::: footer
:::
...
Concepts to consider when evaluating data visualization in published literature or for self-generated reports
:::
...
Find an example from the literature that implements a similar approach
:::
...
- **Assumptions inspectable**: confounding control, batch
...
Single-feature association with outcome: 

a box plot of tumor mutation burden (TMB) across Residual Cancer Burden (RCB) classes [I- good; II-moderate; II-poor response to therapy]
...
:::
<span style="font-size:30%">pCR: pathological complete response </span> <br>
<span style="font-size:30%">RCB: residual cancer burden </span> <br>
<span style="font-size:60%">Sammut, S., et. al. (2021). Nature.</span>
:::
::: footer
:::

## <span style="font-size:80%">Key Takeaways</span> {.smaller}
...
::: incremental
- Data visualization to guide feature selection for downstream model training
- Data visualization to compare model performance
- Data visualization to visualize biological change within data
:::
...
::: incremental
- **Estimating?** $\rightarrow$ create figures with points + intervals
- **Comparing?** groups $\rightarrow$ show the distribution
- **Predicting?** $\rightarrow$ correlations to compare model performance and upstream feature selection
:::
...
- **Estimating?** $\rightarrow$ create figures with points + intervals
- **Comparing?** groups $\rightarrow$ show the distribution
- **Predicting?** $\rightarrow$ pair findings with ROC/PR
